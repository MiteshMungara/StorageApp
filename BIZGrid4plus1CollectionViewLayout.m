...
- (void)setup
{
    self.insetBetweenCells = 2;
    self.numberOfCellsInOneLineGroup = 4;//2
    self.numberOfCellsInTwoLineGroup = 5;//3
}
...
- (void)prepareLayout
{
    ...
    CGFloat smallCellSize = (self.collectionView.bounds.size.width - self.insetBetweenCells * (self.numberOfCellsInOneLineGroup - 1)) / self.numberOfCellsInOneLineGroup;//187.5
//    CGFloat smallCellSize = 100;
    CGFloat bigCellSize = smallCellSize * 2 + self.insetBetweenCells+2;//375
//    CGFloat bigCellSize = 200;
    CGFloat smallImageGroupHeight = smallCellSize + self.insetBetweenCells;//187.5
    CGFloat bigImageGroupHeight = bigCellSize + self.insetBetweenCells;//375
//     CGFloat bigImageGroupHeight =200;
...
//                            frame =  CGRectMake(10, 160, 120, 120);
                            break;
...
//                            frame =  CGRectMake(10, 280, 120, 120);
                            break;
                        ...
                        case 2:
                            ...
                            insetX = 3;
                            cellSize = smallCellSize;
//                            frame =  CGRectMake(140, 160, 220, 242);
                            break;
